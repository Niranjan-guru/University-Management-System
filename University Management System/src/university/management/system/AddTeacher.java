...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        heading.setBounds(300, 30, 300, 50);
        ...
        labelempidText.setBounds(50, 150, 150, 30);
        labelempidText.setFont(new Font("serif", Font.BOLD, 20));
        add(labelempidText);

        labelempid = new JLabel("101" + first4); // Corrected to use the existing label
        ...
        lblaadhar.setBounds(400, 300, 150, 30);
        ...
        String[] course = {"B.Tech", "BBA", "BCA", "Bsc", "Msc", "MBA", "MCA", "MCom", "MA", "BLL"};
        ...
        lblbranch.setBounds(400, 350, 150, 30);
        lblbranch.setFont(new Font("serif", Font.BOLD, 20));
        add(lblbranch);

        String[] branch = {"Computer Science", "Electronics", "Mechanical", "Aerospace", "IT", "Civil"};
